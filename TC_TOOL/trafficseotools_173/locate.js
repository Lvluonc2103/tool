(async () => {
  ...
  (t = self),
    (e = () =>
      (() => {
        ...
        i.r(e),
          i.d(e, { default: () => V, getCssSelector: () => L }),
          ((t = r = r || {}).NONE = "none"),
        ...
        function m(t = []) {
          ...
          return 0 === e.length
            ? t
            : e.reduce((t, e) => t.filter((t) => e.includes(t)), t);
        }
        function g(t) {
          return [].concat(...t);
        }
        ...
        const a = {
          ...
          y = E(["class", "id", "ng-*"]);
        function x({ nodeName: t }) {
          return `[${t}]`;
        }
        function S({ nodeName: t, nodeValue: e }) {
          return `[${t}='${T(e)}']`;
        }
        function w(n) {
          var t = Array.from(n.attributes).filter((t) => {
            ...
            return (
              ...
              !((["input", "option"].includes(e) && "value" === t) || y(t))
            );
          });
        ...
        function k(e = [], { maxResults: t = Number.POSITIVE_INFINITY } = {}) {
          var n = [];
          let i = 0,
            r = I(1);
        ...
        function B(t) {
          return t.includes(c.tag) || t.includes(c.nthoftype)
            ? [...t]
            : [...t, c.tag];
        }
        function U(e = {}) {
          var t = [...$];
          return (
            e[c.tag] && e[c.nthoftype] && t.splice(t.indexOf(c.tag), 1),
            t
              .map((t) => {
          ...
          i.root,
            (s = (function (a, n) {
              const {
                ...
                h = E(e);
              return (function () {
                var { selectors: t, includeTag: e } = n,
                  t = [].concat(t);
                ...
                return (
                  (t[e] = d ? k(s, { maxResults: c }) : s.map((t) => [t])), t
                );
              }, {});
            })(t, (o = i))),
            (a = s),
            ...
            (s = g(
              (function () {
                var {
                  ...
                  e = e ? k(t, { maxResults: i }) : t.map((t) => [t]);
                return n ? e.map(B) : e;
              })()
                .map((t) => {
                  {
        ...
        function G({ selectors: e, operator: t }) {
          let n = [...$],
            i =
              (e[c.tag] && e[c.nthoftype] && (n = n.filter((t) => t !== c.tag)),
              "");
          return (
            n.forEach((t) => {
              (e[t] || []).forEach(({ value: t, include: e }) => {
                e && (i += t);
              });
            }),
            t.value + i
              ...
              .map((t) => {
                t = (function (n, t, e = r.NONE) {
                  ...
                  return (
                    ...
                    { element: n, operator: a[e], selectors: i }
                  );
                })(t, [c.nthchild], r.DESCENDANT);
                return (
                  t.selectors.nthchild.forEach((t) => {
                    t.include = !0;
                  }),
                  t
                );
        ...
        function L(t, e = {}) {
          const o = (function (t) {
            ...
            s =
              (([t, e = {}] = [o[0], e]),
              (e = Object.assign(Object.assign({}, h), e)),
              {
                selectors:
                  ((n = e.selectors),
                  Array.isArray(n)
          ...
          let r = i();
          for (; r; ) {
            const { foundElements: t, selector: c } = r;
  ...
  class r {
    ...
    initialize_style() {
      ...
      n() ||
        ...
        this.$style.styleSheet
          ? (this.$style.styleSheet.cssText = t.join("\n"))
      ...
      (this.$wrapper = document.createElement("div")),
        ...
        n() ||
          ...
          this.$header.classList.add(
            this.NAMESPACE + "_textbox",
            this.NAMESPACE + "_header"
          ),
          (t =
            "textcaptcha_image_selector" === this.locate
              ? "<b>Image</b>"
              : "<b>Input</b>"),
    ...
    clip(t) {
      var e = {
        ...
        width:
          t.width + t.left > window.innerWidth
            ? window.innerWidth - t.left
            : t.width,
        height:
          t.height + t.top > window.innerHeight
            ? window.innerHeight - t.top
            : t.height,
      };
      return (
        t.top < 0 && (e.height += t.top),
        t.left < 0 && (e.width += t.left),
        e.width < 0 && (e.width = 0),
    ...
    computed_style(t, e) {
      ...
      for (const i in (n = n.match(/[\-]?[\d\.]+px/g)))
        n[i] = parseFloat(n[i].replace("px", ""));
      return (
        1 === n.length && n.push(n[0], n[0], n[0]),
        2 === n.length && n.push(n[0], n[1]),
    ...
    clear() {
      this.$t = null;
      var t = { top: 0, left: 0, width: 0, height: 0 };
      this.set_dim(this.$margin_box, t),
        this.set_dim(this.$border_box, t),
        this.set_dim(this.$padding_box, t),
        this.set_dim(this.$content_box, t),
        this.draw_mark &&
          ((this.$mark.style.top = "0px"), (this.$mark.style.left = "0px"));
    }
    update(a, t = 0) {
      const d = this;
      (d.$last && d.$last === a) ||
        (a && (d.$t = a),
        d.$t &&
          (clearTimeout(d.update_timer),
          (d.update_timer = setTimeout(() => {
            var t, e, n, i, r, o, s;
            d.$t?.getBoundingClientRect &&
              ((r = d.$t.getBoundingClientRect()),
              (o = d.computed_style(d.$t, "margin")),
              (s = d.computed_style(d.$t, "border-width")),
              (t = d.computed_style(d.$t, "padding")),
              (r = {
                top: r.top,
                left: r.left,
                width: r.width,
              ...
              d.sub_dim(i, [s]),
              d.sub_dim(r, [s, t]),
              d.set_dim(d.$margin_box, e),
              d.set_dim(d.$border_box, n),
              d.set_dim(d.$padding_box, i),
              d.set_dim(d.$content_box, r),
              (o = d.get_css(d.$t)),
              d.update_css_selector(d.window_id, o),
              BG.exec("Relay.send", {
                data: {
              ...
              d.draw_mark) &&
              ((s = d.get_center(a)),
              (d.$mark.style.top = parseInt(s.y - d.MARK_RADIUS) + "px"),
              (d.$mark.style.left = parseInt(s.x - d.MARK_RADIUS) + "px"));
          }, t))));
    }
    update_css_selector(t, e) {
      this.window_id !== t && this.clear(),
        n() || (this.$footer.innerHTML = `<div>${e}</div>`);
    }
    terminate() {
  ...
  function s(t) {
    ...
    BG.exec("Settings.set", { id: o.locate, value: t }), l(!0);
  }
  function a(t) {
    t = t.target;
    o.update(t);
  ...
  function c(t) {
    ...
    let e = !1;
    (e =
      "key" in t ? "Escape" === t.key || "Esc" === t.key : 27 === t.keyCode) &&
      l(!0);
  }
  function l(t) {
    try {
      document.body.removeEventListener("click", s),
        ...
        document.body.removeEventListener("mousewheel", d),
        document.body.removeEventListener("keydown", c),
        o.terminate(),
        (o = null);
    } catch (t) {}
    t && BG.exec("Relay.send", { data: { action: "stop_locate" } });
  }
  chrome.runtime.onMessage.addListener((t, e, n) => {
    var i;
    "start_locate" === t.action
      ? ((i = t.locate),
        (o = new r(i)),
        document.body.addEventListener("click", s),
        document.body.addEventListener("mousemove", a),
        document.body.addEventListener("mousewheel", d),
        document.body.addEventListener("keydown", c))
      : "stop_locate" === t.action
      ? l(!1)
      : "update_locate" === t.action &&
        o.update_css_selector(t.window_id, t.css_selector);
  });
})();
